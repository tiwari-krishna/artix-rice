...
globalkeys = gears.table.join(
    awful.key({ modkey }, "a", function () awful.util.spawn( terminal.." -e ranger" ) end,
    ...
    awful.key({ altkey, "Control"  }, "v", function () awful.util.spawn( terminal.." -e pulsemixer" ) end,
        {description = "Pulsemixer" , group = "Terminal apps" }),

    awful.key({ modkey, "Shift"  }, "BackSpace", function () awful.util.spawn( "power" ) end,
        {description = "Scripts" , group = "apps" }),
    awful.key({ altkey,  }, "Menu", function () awful.util.spawn( "radio-listen" ) end,
        {description = "Scripts" , group = "apps" }),
    awful.key({ altkey,  }, "r", function () awful.util.spawn( "radio-listen" ) end,
        {description = "Scripts" , group = "apps" }),
    awful.key({ modkey,  }, "space", function () awful.util.spawn( "dmenu_run" ) end,
        {description = "Run Launcher" , group = "apps" }),

    awful.key({ altkey,  }, "s", function () awful.util.spawn( "maim ~/Data/screenshots/$(date +%Y-%m-%d-%s).png" ) end,
        {description = "Full Screen Screenshot" , group = "Miscellanous" }),
    awful.key({ altkey, "Shift" }, "s", function () awful.util.spawn( "maim -s ~/Data/screenshots/$(date +%Y-%m-%d-%s).png" ) end,
        {description = "Selective Screenshot" , group = "Miscellanous" }),
    awful.key({  }, "Print", function () awful.util.spawn( "maim ~/Data/screenshots/$(date +%Y-%m-%d-%s).png" ) end,
        {description = "Full Screen Screenshot" , group = "Miscellanous" }),
    awful.key({ "Shift" }, "Print", function () awful.util.spawn( "maim -s ~/Data/screenshots/$(date +%Y-%m-%d-%s).png" ) end,
        {description = "Selective Screenshot" , group = "Miscellanous" }),
    awful.key({  }, "XF86AudioRaiseVolume", function () awful.util.spawn( "pamixer --allow-boost -i 3" ) end,
    ...
    awful.key({  }, "XF86AudioLowerVolume", function () awful.util.spawn( "pamixer --allow-boost -d 3" ) end,
    ...
    awful.key({ altkey, modkey }, "equal", function () awful.util.spawn( "xbacklight -inc 5%" ) end,
        {description = "Increase Brightness" , group = "Brightness" }),
    awful.key({ altkey, modkey }, "minus", function () awful.util.spawn( "xbacklight -dec 5%" ) end,
        {description = "Decrease Brightness" , group = "Brightness" }),
    awful.key({ modkey, "Control" }, "r", function () awful.util.spawn( "mpv --untimed --no-cache --no-osc --no-input-default-bindings --profile=low-latency --input-conf=/dev/null --title=webcam /dev/video0" ) end,
        {description = "MPV Webcam" , group = "Multimedia" }),

    awful.key({ altkey, }, "Up", function () awful.util.spawn( "pamixer --allow-boost -i 3" ) end,
    ...
    awful.key({ altkey, }, "Down", function () awful.util.spawn( "pamixer --allow-boost -d 3" ) end,
        {description = "Dec MPD volume" , group = "Multimedia" }),
    ...
    awful.key({ modkey, "Shift" }, "x", function () awful.util.spawn( "pcmanfm" ) end,
    ...
    awful.key({ modkey,  }, "d", function () awful.util.spawn( "clipgrab" ) end,
        {description = "Media Downloader" , group = "Graphical apps" }),
    awful.key({ modkey, "Shift" }, "d", function () awful.util.spawn( "rofi -show drun -show-icons" ) end,
        {description = "Rofi Apps Launcher" , group = "Run Launcher" }),
    awful.key({ modkey,  }, "Menu", function () awful.util.spawn( "rofi -show emoji" ) end,
        {description = "Emoji Picker" , group = "Miscellanous" }),
    awful.key({ modkey,  }, "v", function () awful.util.spawn( "qbittorrent" ) end,
        {description = "Torrent Client" , group = "Graphical apps" }),
    awful.key({ modkey,  }, "slash", function () awful.util.spawn( "web-search" ) end,
        {description = "Web-Search" , group = "Miscellanous" }),
    awful.key({ modkey, "Shift" }, "slash", function () awful.util.spawn( "browser-launch" ) end,
        {description = "Browser-Launch" , group = "Miscellanous" }),
    awful.key({ modkey, "Shift" }, "w", function () awful.util.spawn( "open-bookmarks" ) end,
    ...
    awful.key({ altkey, "Shift"   }, "slash",      hotkeys_popup.show_help,
              {description="show help", group="awesome"}),
    awful.key({ modkey,           }, "bracketleft",   awful.tag.viewprev,
              {description = "view previous", group = "tag"}),
    awful.key({ modkey,           }, "bracketright",  awful.tag.viewnext,
